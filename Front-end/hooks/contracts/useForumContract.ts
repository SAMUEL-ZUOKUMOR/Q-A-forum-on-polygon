...
import ForumContract from '../../../hardhat_2/artifacts/contracts/Forum.sol/Forum.json';
...
const useForumContract = () => {
  ...
  //the address of our deployed contract as well as its abi.
  const contract = wagmi.useContract({
    addressOrName: '0xf3BA257AB3FFb4C0a3Fc65bBf2201418072B6f5E', // Add the address that was output from your deploy script, e.g. '0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512'.
